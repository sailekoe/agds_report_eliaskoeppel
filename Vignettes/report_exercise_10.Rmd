...
davos_flux <- read_csv("../data/FLX_CH-Dav_FLUXNET2015_FULLSET_DD_1997-2014_1-3.csv")
...
laegern_flux <- read_csv("../data/FLX_CH-Lae_FLUXNET2015_FULLSET_DD_2004-2014_1-4.csv")
...
On the left: how the cv model of the davos train set performs on the davos test set (within-site).

On the right: how the cv model of the davos train set performs on the laegern test set (across-site).
```{r, warning=FALSE}
...
On the left: how the cv model of the laegern train set performs on the laegern test set (within-site).

On the right: how the cv model of the laegern train set performs on the davos test set (across-site).
```{r, warning=FALSE}
