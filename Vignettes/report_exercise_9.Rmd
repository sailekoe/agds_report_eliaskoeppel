...
## getting 100 models for k[1:100] with the function k_models I created
...
```
The optimal k in terms of model generalisability would be at the point where the MAE value for the test set (blue dots) is at its minimum. In this case it is not very obvious. It seems as if the minimal MAE is achieved with k = 20. 
